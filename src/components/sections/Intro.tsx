export default function Intro() {
  return (
    <section className="py-12 bg-gradient-to-b from-dark-950 to-dark-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto p-6 bg-dark-900/50 backdrop-blur border border-dark-800 rounded-lg">
          <p className="text-dark-100 leading-relaxed text-sm sm:text-base">
